...
public class Arquivo_Ou_Pasta {     
    ...
    public static boolean deletar_Todos_Arquivos_da_Pasta( File file_ou_pasta ) {  boolean retorno = false;
     ...
     public static boolean copiarArquivoDoJar( Class Classe_Das_Imagens, String origem, String destino ) { boolean retorno = false;
         try { File f = new File( origem );
         
             InputStream inputStream = Classe_Das_Imagens.getClass().getResourceAsStream(origem);
    ...
    // Se o Arquivo não existir este método criar e digita a String enviada
    // Se existir, não apaga o que tem e escreve a string enviada
    public static boolean escrever_Em_Arquivo_Boo(String end_Arquivo, String letraDig) {
                ...
                if ( listaDosArquivos != null ) { 
                    ...
                    for (int j=0; j < listaDosArquivos.length; j++) {
                        ...
                        if ( veriF.isDirectory() ) {
                            ...
                            Arquivo_Ou_Pasta.copiarArquivo( veriF, destino ); 
                        }
                    }
