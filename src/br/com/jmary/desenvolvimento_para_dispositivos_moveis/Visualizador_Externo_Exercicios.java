 ...
 * @author admin
 */
public class Visualizador_Externo_Exercicios extends javax.swing.JPanel {
     ...
     * @param altura2
     */
    public Visualizador_Externo_Exercicios( Home Home2, JTabbedPane tabAssunto_Recebido2, Class Classe_Das_Imagens2, int img_Atual2, String endereco_Externo_da_Pasta2, int largura2, int altura2 ) {
        initComponents();
    ...
    private void jLabel5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MousePressed
        ...
        new Thread() {   @Override public void run() { try { //Thread.sleep( 1 );
            ...
            tabAssunto_Recebido.add(String.valueOf( img_Atual ), 
                    new Visualizador_Externo_Exercicios( Home, tabAssunto_Recebido, img_Atual, nome_do_pacote_endereco_Iterno_Do_Assunto, largura, altura) );
    ...
    if( jLabel10.isEnabled() == true ){
            ...
            if( img_Atual < vxAtual ) {    
                ...
                img_Atual++;
                Home.jPanel4.setVisible(true);
                Home.lb_Reiniciar.setVisible(false);
                setarImagemExterna(img_Atual);
            }
            else{
                ...
                img_Atual++;
                Home.jPanel4.setVisible(false);
                Home.lb_Reiniciar.setVisible(true);
            }
...
*/    
        ...
        try { 
            ...
            while( ( ze = zip.getNextEntry() ) != null ) {
                ...
                if( nomeList[0].trim().equalsIgnoreCase( nome_do_pacote_endereco_Iterno_Do_Assunto ) ){
                    ...
                    try{
                        if( nomeList[1].trim().equalsIgnoreCase("Exercicios") ){
    ...
    public void setarImagemExterna( int img_Atual2 ){ 
        img_Atual = img_Atual2;
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );
                ...
                if( (img_Atual < qtdArquivos) && (img_Atual >= 0) ){
                    ...
                    try{ Home.resposta_Correta = nomeList2[1]; } catch (Exception ex) {} //System.out.println("\n\n 333 - Home.resposta_Correta - " + Home.resposta_Correta);  
