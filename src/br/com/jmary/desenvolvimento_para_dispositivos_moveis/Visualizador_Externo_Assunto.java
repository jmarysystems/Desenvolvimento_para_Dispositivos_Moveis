...
public class Visualizador_Externo_Assunto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/pdf_16_16.gif"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/FonteAum.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/laranja_anterior.png"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/laranja_proximo.png"))); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/laranja_home.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/laranja_proximo.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/FonteDim.png"))); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/FontePadrao.png"))); // NOI18N
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/16_chrome.png"))); // NOI18N
        ...
        lbConteudo_Online.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/jmary/desenvolvimento_para_dispositivos_moveis/imagens_internas/anao.gif"))); // NOI18N
    ...
    private void jLabel13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MousePressed
        ...
        */
        ...
        new Thread() {   @Override public void run() { try { //Thread.sleep( 1 );
            ...
            // Endereço do Arquivo
            String endereco_arquivo = internalStorageDir + s + nome_do_pacote_endereco_Iterno_Do_Assunto + ".html";
            // Criar arquivo
            File file = new File( endereco_arquivo );
            ...
            if (!file.exists()) {
                ...
                Arquivo_Ou_Pasta.deletar( new File( endereco_arquivo ) );
            ...
            // Endereço do Arquivo
            String nome_pasta = "zz_imagens_html";
            String endereco_pasta = internalStorageDir + s + nome_pasta;
            // Criar pasta
            File pasta = new File( endereco_pasta );
            // Se a pasta nao existir, ele gera
            if (!pasta.exists()) {
                // Se a pasta não existir este método criar o arquivo
                Arquivo_Ou_Pasta.criarPasta( internalStorageDir, nome_pasta );   
            }
            else{
                
                // Se a pasta existir este método deleta a pasta
                Arquivo_Ou_Pasta.deletar( new File( endereco_pasta ) ); 
                
                // Se a pasta não existir este método criar o arquivo
                Arquivo_Ou_Pasta.criarPasta( internalStorageDir, nome_pasta );   
            }
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "<html>" );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "<head>" );
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "<title>" );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, nome_do_pacote_endereco_Iterno_Do_Assunto );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</title>" );
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "<style>" );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "body { -webkit-print-color-adjust: exact; }" );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</style>" );
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</head>" );
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "<body>" );
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "   <table border='0' cellpadding='0' cellspacing='0' style='width: 100%; padding: 0px; margin: 0px;'   " );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                
                ...
                Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, 
                    "<tr>" +
                        " <td align='center'> " +
                            " <img src = '" + nome_pasta + "/" + listaDosArquivos.get( i ) + "' >" +
                        "</td>" +    
                    "</tr>"
                );
            }
            
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</table>" );
                        
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</body>" );
            Arquivo_Ou_Pasta.escrever_Em_Arquivo_Boo( endereco_arquivo, "</html>" );
                       
            ////////////////////////////////////////////////////////////////////
            java.awt.Desktop.getDesktop().open( new File( endereco_arquivo ) );
            Exportando.fechar();
        } catch( Exception e ){             
            e.printStackTrace(); 
        } finally{
